package com.perfect.common.utils.file;

import com.perfect.common.exception.file.FileNameLengthLimitExceededException;
import com.perfect.common.exception.file.FileSizeLimitExceededException;
import com.perfect.common.exception.file.InvalidExtensionException;
import com.perfect.common.properies.PerfectConfigProperies;
import com.perfect.common.utils.DateTimeUtil;
import com.perfect.common.utils.security.Md5Utils;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = perfectConfigProperies.getSaveUpdatePath();
    ...
    public static final String extractFilename(MultipartFile file) {
        ...
        filename = DateTimeUtil.datePath() + "/" + encodingFilename(filename) + "." + extension;
        return filename;
    }
