package com.zxh.spring.aspect;


import com.zxh.bean.bo.sys.SysLogBO;
import com.zxh.spring.aspect.annotation.SysLog;
...
public class SysLogAspect {
    ...
    @Pointcut("@annotation(com.zxh.spring.aspect.annotation.SysLog)")
