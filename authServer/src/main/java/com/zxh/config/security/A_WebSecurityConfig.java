...
import com.zxh.handler.MyAuthenticationfailureHandler;
import com.zxh.handler.MyLoginSuccessHandler;
...
@Order(99)
public class A_WebSecurityConfig extends WebSecurityConfigurerAdapter {

    // 调用service
    @Autowired
    private IOauthUserService userSecurityService;
